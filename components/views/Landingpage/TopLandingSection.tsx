    ...
    return (
        <TopLandingContainer className='landing_bg mix-blend-lighten'>
            <div className='max-w-7xl pt-32 sm:pt-44 w-full self-center h-screen flex flex-col items-center lg:items-start px-5 md:px-12 lg:px-16 xl:px-0'>
                ...
                <BigDescText className='mt-4 mb-6 text-center sm:block hidden'>Start your Shezmu journey by clicking launch app</BigDescText>
                <BigDescText className='mt-4 mb-6 text-center sm:hidden block'>Start your Shezmu journey</BigDescText>

                <LaunchAppBtn />
            </div>
            <div className='max-w-7xl w-full self-center flex flex-col items-center px-8 md:px-12 lg:px-16 xl:px-0'>
