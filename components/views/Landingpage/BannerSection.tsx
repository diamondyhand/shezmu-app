    ...
    return (
        <BannerContainer>
            <div className='max-w-7xl w-full self-center flex flex-col items-center sm:mt-28 mt-10 px-5 md:px-12 lg:px-16 xl:px-0'>
                <div className="w-full h-full md:h-[186px] bg-gradient-to-b from-[#000000] hover:from-[#18181B] to-[#18181B] hover:to-[#755c0450] py-12 sm:py-16 px-8 sm:px-16 rounded-[32px] border border-[#D1B03A] flex flex-col md:flex-row items-center justify-between z-20 cursor-pointer transition-all">                                        
